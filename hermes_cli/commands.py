...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("sandbox", "Show or change this session's OS sandbox (file grants, tools, network)",
               "Configuration", args_hint="[grant|revoke|preset|presets|tools|net|unix|scan|reset]",
               subcommands=("grant", "revoke", "preset", "presets", "tools", "net", "unix", "scan", "reset"),
               busy_policy="dispatch"),
